...
The required Data Set are X_mean_avg.txt and X_std_avg.txt.
...
# X_mean_avg.txt
This is a text file, readable with read.table that includes the mean variables
averaged by the dimensions Activity and Subject.

## Dimensions

*"Activity"
It is the activity performed by the subject. Possible values are:
1. WALKING
2. WALKING_UPSTAIRS
...
*"Subject"
It is one of the subject oberved in the experiment. Possible values are from 1 to 30.
...
### Full list of available measure
